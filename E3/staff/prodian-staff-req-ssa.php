  ...
  <div class="pagetitle">
      ...
      <nav>
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active"><a href="prodian-staff-req-ssa.php">Supplies Request</a></li>
        </ol>
      </nav>
    </div><!-- End Page Title -->
        ...
        <script>
          function approveConfirmation(id) {
            Swal.fire({
              ...
              if (result.value) {
                window.location.href = '../../action/staff/approve/approve-req-ssa.php?id=' + id;
              }
            })
          }
        </script>
        ...
        <script>
          function rejectConfirmation(id) {
            Swal.fire({
              ...
              if (result.value) {
                window.location.href = '../../action/staff/reject/reject-req-ssa.php?id=' + id;
              }
            })
          }
        </script>
