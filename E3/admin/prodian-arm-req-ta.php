    ...
    <div class="card-body">
      ...
      <?php  
        ...
        if(isset($_POST['search'])) {
          $search = "%" . $_POST['search'] . "%";
          $stmt = $conn->prepare("SELECT * FROM arm_req_ta WHERE req_name LIKE :search ORDER BY id ASC LIMIT :start, :limit");
          ...
          $stmt = $conn->prepare("SELECT * FROM arm_req_ta ORDER BY id ASC LIMIT :start, :limit");
          $stmt->bindParam(':start', $start, PDO::PARAM_INT);
          $stmt->bindParam(':limit', $limit, PDO::PARAM_INT);
          $stmt->execute();
          $count = $stmt->rowCount();
        ...
        <script>
          function approveConfirmation(id) {
            Swal.fire({
              ...
              if (result.value) {
                window.location.href = '../../action/admin//approve/approve-req-ta.php?id=' + id;
              }
            })
          }
        </script>
        ...
        <script>
          function rejectConfirmation(id) {
            Swal.fire({
              ...
              if (result.value) {
                window.location.href = '../../action/admin//reject/reject-req-ta.php?id=' + id;
              }
            })
          }
        </script>
          ...
          <div class="modal-dialog modal-lg">
            <div class="modal-content">
              ...
              <div class="modal-body">
                  <div class="row">
                    <h5 class="modal-title">Requestor</h5>
                    <div class="col-lg-3 col-md-3 label" style="margin-top: 10px;"><b>First Name</b></div>
                    <div class="col-lg-3 col-md-3 input" style="margin-top: 10px;"><?php echo $row['fname'];?></div>
                    <div class="col-lg-3 col-md-3 label" style="margin-top: 10px;"><b>Last Name</b></div>
                    <div class="col-lg-3 col-md-3 input" style="margin-top: 10px;"><?php echo $row['lname'];?></div>
                  </div>
                  <div class="row">
                    <div class="col-lg-3 col-md-3 label" style="margin-top: 10px;"><b>Position</b></div>
                    <div class="col-lg-3 col-md-3 input" style="margin-top: 10px;">[Input]</div>
                    <div class="col-lg-3 col-md-3 label" style="margin-top: 10px;"><b>Department</b></div>
                    <div class="col-lg-3 col-md-3 input" style="margin-top: 10px;">[input]</div>
                  </div>
                  <div class="row">
                    <div class="col-lg-3 col-md-3 label"><b>Work Branch</b></div>
                    <div class="col-lg-3 col-md-3 input">[Input]</div>
                    <div class="col-lg-3 col-md-3 label"><b>2:</b></div>
                    <div class="col-lg-3 col-md-3 input">[input]</div>
                  </div>
                  <div class="row">
                    <div class="col-lg-3 col-md-3 label"><b>Work Branch:</b></div>
        ...
        ?>
          ...
          <ul class="pagination">
            <li class="page-item <?php if($page <= 1) { echo 'disabled'; } ?>">
              <a class="page-link" href="prodian-arm-req-ta.php?page=<?php echo $page-1; ?>" aria-label="Previous">
          ...
          <?php for($i = 1; $i <= $total_pages; $i++) { ?>
            <li class="page-item <?php if($page == $i) { echo 'active'; } ?>">
              <a class="page-link" href="prodian-arm-req-ta.php?page=<?php echo $i; ?>">
                <?php echo $i; ?>
              </a>
            </li>
          <?php } ?>
            <li class="page-item <?php if($page >= $total_pages) { echo 'disabled'; } ?>">
              <a class="page-link" href="prodian-arm-req-ta.php?page=<?php echo $page+1; ?>" aria-label="Next">
