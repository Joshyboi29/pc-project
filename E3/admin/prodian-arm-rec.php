  ...
  <div class="pagetitle">
    ...
    <div class="card-body">
      ...
      <?php
        ...
        $tables = ['arm_req_rec_oth', 'arm_req_rec_oth_done'];
        $count = 0;
        ...
        foreach ($tables as $table) {
          ...
          while($row=$stmt->fetch(PDO::FETCH_ASSOC)){
            ...
            echo "<td>";
            if ($table == 'arm_req_rec_oth_done') {
              echo "<button class='btn btn-light border shadow-sm' style='width: 120px; height: 40px;' onclick='Confirmation(" . $id . ")'>";
              echo "<a style='Color: #256D85'><i class='bi bi-truck' style='Color: #256D85'></i> Dispatch</a>";
              echo "</button>";
            } else {
              echo "";
            }
      ...
      <script>
        function Confirmation(id) {
          Swal.fire({
            title: 'Are you sure?',
            text: "You want to dispatch this assets!",
            icon: 'warning',
            ...
            if (result.value) {
              window.location.href = '../../action/admin/request/req-oth-dp.php?id=' + id;
            }
          })
        }
      </script>
