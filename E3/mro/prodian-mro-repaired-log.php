...
?>
  ...
  <script>
  var x = document.getElementById('rlog')
    ...
    <div class="card-body">
      ...
      <thead>
          <tr class="align=middle text-center">
            ...
            <th scope="col">Date of repaired</th>
  ...
  <?php }} ?>
    ...
    $stmt = $conn->prepare("SELECT COUNT(*) FROM mro_checkup");
    $stmt->execute();
    ...
    <nav style="float: right; margin-top: 5px">
      <ul class="pagination">
        <li class="page-item <?php if($page <= 1) { echo 'disabled'; } ?>">
          <a class="page-link" href="prodian-mro-repaired-log.php?page=<?php echo $page-1; ?>&limit=<?php echo $limit; ?>" aria-label="Previous">
        ...
        <li class="page-item <?php if($page == $i) { echo 'active'; } ?>">
          <a class="page-link" href="prodian-mro-repaired-log.php?page=<?php echo $i; ?>&limit=<?php echo $limit; ?>">
            <?php echo $i; ?>
          </a>
        </li>
        <?php } ?>
        <li class="page-item <?php if($page >= $total_pages) { echo 'disabled'; } ?>">
          <a class="page-link" href="prodian-mro-repaired-log.php?page=<?php echo $page+1; ?>&limit=<?php echo $limit; ?>" aria-label="Next">
