...
?>
  ...
  var h = document.getElementById('pm-nav')
  ...
  <div class="pagetitle">
      ...
      <nav>
        <ol class="breadcrumb">
          <li class="breadcrumb-item"><a href="prodian-mro-dashboard.php">Home</a></li>
          <li class="breadcrumb-item"><a href="#">Asset Monitoring</a></li>
          <li class="breadcrumb-item active"><a href="#">Equipments</a></li>
        </ol>
      </nav>
    </div><!-- End Page Title -->
    ...
    <button type="button" class="btn-add" data-bs-toggle="modal" data-bs-target="#addassets"><i class="ri-add-fill ri-2x"></i>
        ...
        <div class="modal-dialog">
          <div class="modal-content">
            ...
            <div class="modal-body">
              <form method="POST" action="../../action/mro/add/prodian-add-ta.php" enctype="multipart/form-data" class="row g-3">
                <div class="col-md-12">
      ...
      <tbody>
        ...
        <tr class="align=middle text-secondary text-center" ondblclick="showModal(<?php echo $id;?>)">
          ...
          <td></td>
          <td>
          <button class="btn btn-light border shadow-sm" style="width: 110px; height: 35px;">
          <a href="#update<?php echo $id;?>" data-bs-toggle="modal" style="Color: Green">
          <i class="bi bi-wrench fa-lg" style='color: green;'></i> Monitor</a>
          </button>
          </td>
          ...
          <div class="modal fade" id="update<?php  echo $id;?>" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
            <div class="modal-dialog modal-lg">
              <div class="modal-content">
                ...
                <div class="modal-body">
                <form method="POST" action="../../action/mro/edit/prodian-edit-ta-eq.php<?php echo '?id='.$id; ?>" enctype="multipart/form-data" class="row g-12">
                <?php if($row['a_image'] != ""): ?>
                   <img src="../../assets/img/prodian/<?php echo $row['a_image']; ?>" width="450px" height="450px" style="display: block; margin: 0 auto; max-width: 100%; height: auto;">
                    <?php else: ?>
                    <?php endif; ?>
                    ...
                    <div class="row mb-3">
                      <label for="serialnum" class="col-md-4 col-lg-3 col-form-label">Serial #:</label>
                        <div class="col-md-8 col-lg-9">
                          <input name="serialnum" type="text" class="form-control" id="serialnum" value="<?php echo $row['serial_num'];?>" disabled>
                        </div>
                      </div>
                      ...
                      <label for="brand" class="col-md-4 col-lg-3 col-form-label">Brand:</label>
                        <div class="col-md-8 col-lg-9">
                          <input name="brand" type="text" class="form-control" id="brand" value="<?php echo $row['brand'];?>"disabled>
                        </div>
                      </div>
                      ...
                      <label for="assetname" class="col-md-4 col-lg-3 col-form-label">Asset Name:</label>
                        <div class="col-md-8 col-lg-9">
                          <input name="assetname" type="text" class="form-control" id="assetname" value="<?php echo $row['a_name'];?>"disabled>
                        </div>
                      </div>

                      <div class="row mb-3">
                      <label for="unit" class="col-md-4 col-lg-3 col-form-label">Condition:</label>
                        <div class="col-md-8 col-lg-9">
            ...
            <script>
              function deleteConfirmation(id) {
                Swal.fire({
                  ...
                  if (result.value) {
                    window.location.href = '../../action/mro/delete/prodian-delete-ta-eq.php?id=' + id;
                  }
                })
              }
            </script>
